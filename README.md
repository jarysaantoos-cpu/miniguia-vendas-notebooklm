...
**Funcionou bem? Precisou ajustar?** Funcionou muito bem — a IA organizou sozinha 4 visões distintas do mesmo tema em vez de misturar tudo numa lista genérica. Ponto de atenção: pedir explicitamente "cite a fonte de cada bloco" na próxima rodada, já que ela não deixou claro qual documento embasou cada seção.
...
**Funcionou bem? Precisou ajustar?** Funcionou muito bem de primeira — pedir um número exato (10) e "os mais importantes" trouxe uma lista objetiva e bem distribuída entre os temas das fontes, sem precisar reformular.
